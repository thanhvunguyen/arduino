 ...
 *
 * @method APP_Model where(Array|String $params, Array $options = [])
 * @method APP_Model select(String $statement, Array $options = [])
 * @method APP_Model where_in(Array|String $params, Array $options = [])
 * @method APP_Model where_not_in(Array|String $params, Array $options = [])
 ...
 * @method APP_Model order_by_forcus(String $statement, String $order, Array $options = [])
 * @method APP_Model not_delete()
 ...
 * @method APP_Model like(String $name, String $value, String $dir = null)
 * @method APP_Model for_update()
 * @method APP_Model having(String $condition)
 *
 ...
 *
 * @method string escape_like_str($str)
 * @method string escape_str($str)
 *
...
class APP_Model extends CI_Model implements APP_Model_interface
{
    ...
    public function bulk_create($array, $options = array())
    {
        ...
        return $this->master->insert_batch($this->table_name, $array, null, $options);
    }
     ...
     * @throws APP_DB_exception
     */
    public function destroy_all_without_fk($options = array())
    {
        $this->errors->clear();
